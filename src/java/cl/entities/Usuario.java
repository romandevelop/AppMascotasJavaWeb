...
@NamedQueries({
    ...
    , @NamedQuery(name = "Usuario.iniciarSesion", 
            query = "SELECT u FROM Usuario u WHERE u.rutUser = :rutUser and u.clave= :clave")})
public class Usuario implements Serializable {
    ...
    public String toString() {
        return "cl.entities.Usuario[ rutUser=" + rutUser + " ]";
    }
